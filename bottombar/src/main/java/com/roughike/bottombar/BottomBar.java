...
public class BottomBar extends LinearLayout implements View.OnClickListener, View.OnLongClickListener {
    ...
    private void populateAttributes(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        primaryColor = MiscUtils.getColor(getContext(), android.R.attr.colorPrimary);
    ...
    public BottomBarTab getTabWithId(@IdRes int tabId) {
        return tabContainer.findViewById(tabId);
    }
    ...
    public void onRestoreInstanceState(Parcelable state) {
        if (state instanceof Bundle) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
                state = bundle.getParcelable("superstate", Parcelable.class);
            } else {
